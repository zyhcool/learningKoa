...
let keygrip = Keygrip(["ha1","en"]);
console.log(keygrip);

let sign1 = keygrip.sign("123456");
let sign2 = keygrip.sign("1234561");
console.log(sign1,sign2)

console.log(keygrip.verify("123456","8nb9OtL274d_uNE5ZXu3gaI1SMk"))

console.log(keygrip.index("123456","8nb9OtL274d_uNE5ZXu3gaI1SMk"))
